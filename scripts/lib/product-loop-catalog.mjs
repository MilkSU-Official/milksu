...
export const CASES = {
  ...
  'settings-permissions': item('settings-permissions', '权限与操控', 'settings-rest'),
  'settings-models': item('settings-models', '模型', 'settings-rest'),
  'settings-runtime': item('settings-runtime', '运行时', 'settings-rest'),
...
export const MODULES = {
  ...
  'settings-rest': {
    ...
    cases: [
      ...
      'settings-skills', 'settings-mcp', 'settings-chats', 'settings-memory', 'settings-browser', 'settings-eval', 'settings-companion', 'settings-plugins',
    ],
  },
}
