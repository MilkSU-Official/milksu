...
export const MODULES = {
  ...
  intent: {
    ...
    needsCredential: true,
    isolated: true,
    detail: '意图识别专题。闲聊、深入思考、长任务；做完、待批、真报错直接通知；卡住才判断说不说；记忆留或丢；折叠记录与主模型兜底。不进默认全量回归。',
    cases: [
      'intent-settings-blank', 'intent-chat', 'intent-deep', 'intent-long',
      'intent-done', 'intent-approval', 'intent-error', 'intent-stall',
      'intent-memory', 'intent-other-silent', 'intent-fallback-record',
    ],
  },
  workspaces: {
    id: 'workspaces',
