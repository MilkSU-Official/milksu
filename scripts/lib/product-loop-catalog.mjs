...
export const CASES = {
  ...
  'companion-page': item('companion-page', '桌宠小窗', 'companion'),
  'companion-pet-menu': item('companion-pet-menu', '桌宠右键菜单', 'companion'),
  'companion-pet-drag': item('companion-pet-drag', '桌宠身体拖拽', 'companion'),
  'companion-core': item('companion-core', '桌宠核心循环', 'companion', true),
  ...
  'companion-hide': item('companion-hide', '隐藏桌宠', 'companion'),
  'companion-show': item('companion-show', '显示桌宠', 'companion'),
...
export const MODULES = {
  ...
  companion: {
    ...
    needsCredential: true,
    isolated: true,
    detail: '桌宠手机对话、右键菜单、身体拖拽、就绪、核心循环（开测时写入多条真实议题抄本，再在手机里提问、按停止、收尾），归档、记忆、功能询问，回合结束后停再续跑，设置里的模型、调度、主动性、悬浮窗、出厂皮肤和第三方换装，以及隐藏、显示、关掉主窗口后从 Dock / 任务栏唤醒。',
    cases: [
      'companion-ready', 'companion-page', 'companion-pet-menu', 'companion-pet-drag', 'companion-core',
      'companion-archive', 'companion-memory', 'companion-dispatch-confirm', 'companion-fuzz-app',
