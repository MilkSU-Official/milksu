...
export const MODULES = {
  ...
  coding: {
    ...
    needsCredential: true,
    isolated: true,
    detail: 'Pi 与 DSH 日常开发：写文件、改文件、跑命令、插话、排队、停止、整理上下文、选择卡、计划、目标、并行，以及会话壳、输入栏和一条直接写下的用户记忆。',
    cases: [
      'coding-pi-files', 'coding-pi-shell', 'coding-pi-edit', 'coding-pi-compact', 'coding-pi-steer', 'coding-pi-stop', 'coding-pi-ask', 'coding-pi-ask-continue', 'coding-cite', 'coding-attach', 'coding-pi-handoff', 'coding-user-memory',
