...
export const runIntentStatus = pending('追问不另派')
export const runIntentDone = pending('做完她通知')
export const runIntentNoticesMerge = pending('两条通知都在')
export const runIntentApproval = pending('待批她通知')
export const runIntentError = pending('真报错她通知')
export const runIntentToolContinues = pending('工具失败后还盯着')
...
export const runIntentNoticeWaits = pending('开口时不串话')
