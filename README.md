...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.911.1"><img src="https://img.shields.io/badge/latest_release-26.911.1-f3f0e8?style=flat-square&labelColor=20211f" alt="Latest GitHub Release 26.911.1"></a>
...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.911.1">下载</a>
  ·
...
最近一次带哈希回执的三端正式 GitHub Release 是 **26.911.1**（2026-09-11）：宽作业父循环熔断、插件框架、CUA 0.27.0、设置 subagent / DeepSeek 中转。Windows 安装器仍未代码签名；Linux 无 Secret Service 与本地 OCR；Hyprland/Xorg Computer Use 不可用。
