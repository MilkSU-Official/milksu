...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.922.2"><img src="https://img.shields.io/badge/latest_release-26.922.2-f3f0e8?style=flat-square&labelColor=20211f" alt="Latest GitHub Release 26.922.2"></a>
...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.922.2">下载 26.922.2</a>
  ·
...
当前安装包是 **[26.922.2](https://github.com/MilkSU-Official/milksu/releases/tag/v26.922.2)**：macOS ARM64 DMG（Developer ID 签名并公证，安装引导图为 Retina @2x）、Windows x64 EXE、Linux x64 `.deb` 与 `.tar.gz`。这一版看板娘可以拖到另一块屏幕，界面是冷白液态玻璃。Windows 安装器尚未代码签名，可能被 SmartScreen 拦住。已登录后侧栏「更新」打开进度框下载，下完后点安装并重启。
...
```bash
# Ubuntu / Debian
sudo apt install ./MilkSU-Linux-x64-26.922.2.deb
