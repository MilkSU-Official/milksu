...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.912.2"><img src="https://img.shields.io/badge/latest_release-26.912.2-f3f0e8?style=flat-square&labelColor=20211f" alt="Latest GitHub Release 26.912.2"></a>
...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.912.2">下载</a>
  ·
...
最近一次带哈希回执的三端正式 GitHub Release 是 **26.912.2**（2026-09-12）：新对话可选 Pi 或 DeepSeek Harness，附件原图交给当前模型，已发送图片显示缩略图。Windows 安装器仍未代码签名；Linux 无 Secret Service 与本地 OCR；Hyprland/Xorg Computer Use 不可用。
