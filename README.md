...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.911.2"><img src="https://img.shields.io/badge/latest_release-26.911.2-f3f0e8?style=flat-square&labelColor=20211f" alt="Latest GitHub Release 26.911.2"></a>
...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.911.2">下载</a>
  ·
...
最近一次带哈希回执的三端正式 GitHub Release 是 **26.911.2**（2026-09-11）：CVE 同步不再混进跟踪列表、DeepSeek 可先存再启用、安装重启失败可见，正式打包上传 OTA 后自动发布。Windows 安装器仍未代码签名；Linux 无 Secret Service 与本地 OCR；Hyprland/Xorg Computer Use 不可用。
