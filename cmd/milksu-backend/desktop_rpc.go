...
func desktopAppMethods(app *App) map[string]desktopAppMethod {
	return map[string]desktopAppMethod{
		...
		"ListCodingToolSkills":                 rendererDesktopMethod(app.ListCodingToolSkills),
		"CheckCodingToolSkill":                 rendererDesktopMethod(app.CheckCodingToolSkill),
		"StartCodingToolSkillSetup":            rendererDesktopMethod(app.StartCodingToolSkillSetup),
		"GetCodingToolSkillSetup":              rendererDesktopMethod(app.GetCodingToolSkillSetup),
		...
		"ListCompanionTranscript":              rendererDesktopMethod(app.ListCompanionTranscript),
		"ArchiveCompanionTranscript":           rendererDesktopMethod(app.ArchiveCompanionTranscript),
		"ListCompanionArchives":                rendererDesktopMethod(app.ListCompanionArchives),
		"DeleteCompanionArchive":               rendererDesktopMethod(app.DeleteCompanionArchive),
		"GetCompanionMemory":                   rendererDesktopMethod(app.GetCompanionMemory),
		"ApproveCompanionMemory":               rendererDesktopMethod(app.ApproveCompanionMemory),
		"ForgetCompanionMemory":                rendererDesktopMethod(app.ForgetCompanionMemory),
		...
		"QueueDshMessage":                      rendererDesktopMethod(app.QueueDshMessage),
		"ListDshCommands":                      rendererDesktopMethod(app.ListDshCommands),
		"ExecuteDshCommand":                    rendererDesktopMethod(app.ExecuteDshCommand),
		"SetDshPlanMode":                       rendererDesktopMethod(app.SetDshPlanMode),
		"ControlDshGoal":                       rendererDesktopMethod(app.ControlDshGoal),
		"KillDshJob":                           rendererDesktopMethod(app.KillDshJob),
		...
		"GetCTFMemoryOverview":                 rendererDesktopMethod(app.GetCTFMemoryOverview),
		...
		"StartEvalRun":                         rendererDesktopMethod(app.StartEvalRun),
		"StopEvalRun":                          rendererDesktopMethod(app.StopEvalRun),
		"ListAgentResourceCatalog":             rendererDesktopMethod(app.ListAgentResourceCatalog),
		"GetBuiltinSkillDocument":              rendererDesktopMethod(app.GetBuiltinSkillDocument),
		"SetBuiltinSkillDocument":              rendererDesktopMethod(app.SetBuiltinSkillDocument),
		"RestoreBuiltinSkill":                  rendererDesktopMethod(app.RestoreBuiltinSkill),
		"UpsertBuiltinMCP":                     rendererDesktopMethod(app.UpsertBuiltinMCP),
		"SetBuiltinMCPEnabled":                 rendererDesktopMethod(app.SetBuiltinMCPEnabled),
		"RestoreBuiltinMCP":                    rendererDesktopMethod(app.RestoreBuiltinMCP),
		"PrepareBuiltinConfigHandoff":          rendererDesktopMethod(app.PrepareBuiltinConfigHandoff),
		"UpsertUserMCPServer":                  rendererDesktopMethod(app.UpsertUserMCPServer),
		"ImportUserMCPJSON":                    rendererDesktopMethod(app.ImportUserMCPJSON),
		"SetUserMCPServerEnabled":              rendererDesktopMethod(app.SetUserMCPServerEnabled),
		"DeleteUserMCPServer":                  rendererDesktopMethod(app.DeleteUserMCPServer),
		"ImportUserSkill":                      rendererDesktopMethod(app.ImportUserSkill),
		"SetUserSkillEnabled":                  rendererDesktopMethod(app.SetUserSkillEnabled),
		"DeleteUserSkill":                      rendererDesktopMethod(app.DeleteUserSkill),
		"RewindCodingSession":                  rendererDesktopMethod(app.RewindCodingSession),
		"HandoffCodingSession":                 rendererDesktopMethod(app.HandoffCodingSession),
		"ForkConversation":                     rendererDesktopMethod(app.ForkConversation),
		"GetBrowserUseRuntime":                 rendererDesktopMethod(app.GetBrowserUseRuntime),
		"ChooseLabPath":                        rendererDesktopMethod(app.ChooseLabPath),
		"GetLabEnvironmentStatus":              rendererDesktopMethod(app.GetLabEnvironmentStatus),
		"ListLabPackages":                      rendererDesktopMethod(app.ListLabPackages),
		"ListEnvLeases":                        rendererDesktopMethod(app.ListEnvLeases),
		"GetEnvLease":                          rendererDesktopMethod(app.GetEnvLease),
		"GetEnvPackageForCVE":                  rendererDesktopMethod(app.GetEnvPackageForCVE),
		"StartEnvLease":                        rendererDesktopMethod(app.StartEnvLease),
		"ProbeEnvLease":                        rendererDesktopMethod(app.ProbeEnvLease),
		"ResetEnvLease":                        rendererDesktopMethod(app.ResetEnvLease),
		"StopEnvLease":                         rendererDesktopMethod(app.StopEnvLease),
