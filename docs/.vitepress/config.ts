      ...
      '/developer/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '产品闭环冲刺摘要', link: '/developer/product-loop-sprint' },
            { text: '产品闭环验收索引', link: '/developer/product-loop-sprint-acceptance' },
            { text: '旧目标台账摘要', link: '/developer/objective-coverage-ledger' },
            { text: '旧目标评估摘要', link: '/developer/objective-review-workbook' },
