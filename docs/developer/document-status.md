...
| 三端正式发行 | GitHub Latest Release `v26.905.1` 已提供签名并公证的 macOS ARM64 DMG、未签名 Windows x64 EXE、Linux x64 DEB 与 x64 tar.gz，以及 `SHA256SUMS-26.905.1.txt`。OTA 草稿应已上传私有 R2；Admin current pointer 仍须维护者在「版本」页发布。 |
