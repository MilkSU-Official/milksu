...
| 最近发行回执 | macOS `34631399583`、Windows `34631403377`、Linux `34631407080` 均成功。文件名、大小和 SHA-256 记录在当前开发目标。 |
...
- 下载页与对外状态以 `26.912.2` 回执为准；晚于 `f7782c1` 的 `main` 只描述当前仓库，不能改写该发行页。上一版 `v26.911.2`、`v26.911.1`、`v26.905.2`、`v26.905.1`、`v26.904.1` 与 `v26.827.1` 仍可下载。`v26.912.1` 从未作为 GitHub Latest 发出。
