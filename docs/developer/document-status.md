...
| 最近发行回执 | macOS `33957104110`、Windows `33957107466`、Linux `33957110196` 均成功。文件名、大小和 SHA-256 记录在当前开发目标。 |
...
- 下载页与对外状态以 `26.905.2` 回执为准；晚于 `b18b860` 的 `main` 只描述当前仓库，不能改写该发行页。上一版 `v26.905.1`、`v26.904.1` 与 `v26.827.1` 仍可下载。
