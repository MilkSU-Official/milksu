...
>
> 最近已推送代码基线：2026-08-05，`72049da`
>
> 最近证据复核：2026-08-05，`72049da` 完整 `npm run m3:release-check` 通过并重新生成
