...
| 桌宠模糊调度 | 用人话让桌宠去看板、把调研派到指定对话；不点名工具 schema。标记必须进目标会话。只调了工具、看板上有标题不算。host 超时是错误。 |
...
| 桌宠连发 | 短间隔连发三句，sidecar 不崩，抄本至少留下其中 2 个用户标记。 |
...
| 隐藏桌宠 | 走产品隐藏路径后，壳报告桌宠已藏。Wayland 没有悬浮窗可藏：SKIP。 |
