...
| Coding 日常工作流 | 已完成窄真实闭环 | 输入框上方仅保留 Plan/Go、权限和模型；项目、能力、架构图、变更、终端和浏览器集中在右侧。原生 App 已连续完成理解、修改、测试、修复和总结；本地远端已验 stage、commit、push；右侧终端已验短命令和 HTTP 服务启停并按 Conversation 隔离 | 仍缺逐块/行级审阅、托管平台 PR、交互式 PTY、Browser、Computer Use、多 Agent 和更大项目样本 |
