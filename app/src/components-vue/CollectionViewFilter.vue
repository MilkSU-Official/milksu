...
<template>
  <div class="collection-tabs flex min-w-0 shrink items-center overflow-x-auto border border-border bg-card/45" role="tablist" aria-label="收藏夹">
    <button
      type="button"
...
<style scoped>
.collection-tabs { border-radius: .45rem; scrollbar-width: none; }
