...
export default function SecurityToolsProductionPreview() {
  const [theme] = useState<ResolvedThemeMode>('dark')
  const [settings, setSettings] = useState(() => withAppSettingsDefaults({} as AppSettings))
